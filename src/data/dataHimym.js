export const HimymChar = [
  {
    "id": "himymchar1",
    "title": "Ted Mosby",
    "file": "TedMosby",
    "route": "/himym/ted_mosby"
  },
  {
    "id": "himymchar2",
    "title": "Marshall Eriksen",
    "file": "MarshallEriksen",
    "route": "/himym/marshall_eriksen"
  },
  {
    "id": "himymchar3",
    "title": "Lily Aldrin",
    "file": "LilyAldrin",
    "route": "/himym/lily_aldrin"
  },
  {
    "id": "himymchar4",
    "title": "Robin Scherbatsky",
    "file": "RobinScherbatsky",
    "route": "/himym/robin_scherbatsky"
  },
  {
    "id": "himymchar5",
    "title": "Barney Stinson",
    "file": "BarneyStinson",
    "route": "/himym/barney_stinson"
  },
  {
    "id": "himymchar6",
    "title": "Tracy McConnell",
    "file": "TracyMcConnell",
    "route": "/himym/tracy_mcconnell"
  }
];

export const HimymEps = [
  {
    "id": "himyms1e1",
    "title": "Pilot",
    "season": 1,
  ...
  {
    "id": "himyms6e5",
    "title": "Architect of Desctruction",
    "season": 6,
    "episode": 117,
    "file": "HimymS6E5",
    "img": "",
...
export const himymS1 = HimymEps.filter((s1) => s1.season == 1);
export const himymS2 = HimymEps.filter((s2) => s2.season == 2);
export const himymS3 = HimymEps.filter((s3) => s3.season == 3);
export const himymS4 = HimymEps.filter((s4) => s4.season == 4);
export const himymS5 = HimymEps.filter((s5) => s5.season == 5);
export const himymS6 = HimymEps.filter((s6) => s6.season == 6);
export const himymS7 = HimymEps.filter((s7) => s7.season == 7);
export const himymS8 = HimymEps.filter((s8) => s8.season == 8);
export const himymS9 = HimymEps.filter((s9) => s9.season == 9);