...
import { routesTopics, routesAssassinsCreed, routesCommunityChars, routeGfChars, routeGfS1, routesGta, routesGtaChars, routesMcu, routesMcuChars, routesMcuMeta, routesSWFilms, routesSWSeries, routeSWCharacters } from "./articles"
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {routesMcuChars.map(({ path, Component}, index) => (
          <Route key={index} path={path} element={<Component />} />
        ))}
        ...
        {routesSWSeries.map(({ path, Component}, index) => (
          <Route key={index} path={path} element={<Component />} />
        ))}

        {routeSWCharacters.map(({ path, Component}, index) => (
          <Route key={index} path={path} element={<Component />} />
        ))}
